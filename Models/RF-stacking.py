...
if __name__ == "__main__":
    ...
    train_dataset = pd.read_csv(f"{train_test_path}Train.csv")
    test_dataset = pd.read_csv(f"{train_test_path}Test.csv")
